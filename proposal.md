...
## Customer Value
  ...
  > When people discuss their favorite video games of all time, there will no doubt be a number of side-scrollers mentioned...love them or hate them, there is no questioning their impact on gaming or the fact that some amazing side-scrollers have been released.
...
## Project Management 
  ...
  **Time Line:**
  - 2/4/19 - 2/18/19: Build the game foundation and framework, main game loop, rendering, resource loading(sprites, music, sound effects), core object creation, object controller, key and mouse input detection(possible xbox controller support). 
